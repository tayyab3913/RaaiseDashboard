...
```powershell
cd "d:\Official Github Repositories\Raaise Dashboard\RAAISE-MVP-3"
...
```powershell
cd "d:\Official Github Repositories\Raaise Dashboard\RAAISE-MVP-3\raaise-dashboard-wording-updated"
npm run dev
```
