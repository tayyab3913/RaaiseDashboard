  ...
  return (
    <div>
      ...
      <div className="bg-white p-2 rounded">
        <div className="mb-2">
          <h3 className="font-bold text-base mb-1">Sensors</h3>
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 rounded-xs bg-lime-500"></div>
            <span className="text-sm">NFC Reader (NFxx)</span>
          </div>
          
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 rounded-xs bg-cyan-500 "></div>
            <span className="text-sm">RFID Reader (RFxx)</span>
          </div>
        
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 rounded-xs bg-orange-500"></div>
            <span className="text-sm">FP Reader (FPxx)</span>
          </div>
        
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 rounded-xs bg-pink-500"></div>
            <span className="text-sm">PIR Sensor (PSxx)</span>
          </div>
        
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 rounded-xs bg-yellow-500"></div>
            <span className="text-sm">CCTV Reader (CCxx)</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 rounded-xs bg-gray-500 "></div>
            <span className="text-sm">WiPS Access Point (WPxx)</span>
          </div>
        </div>
        <div>
    ...
    <ul className="space-y-2">
      {sensorsWithStatus.map((sensor) => (
        <li key={sensor.SENSORID} className="bg-white p-2 rounded shadow flex justify-between text-xs">
          <p className="font-bold">Sensor {sensor.SENSORID}</p>
